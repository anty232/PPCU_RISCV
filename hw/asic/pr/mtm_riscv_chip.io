...
(iopad
    ...
    (bottom
	(inst  name="u_pads_in/u_uart_sin"	 place_status=placed offset = 190)
	(inst  name="u_pads_pwr/VSS3_3_"	 place_status=placed space = 70)
    ...
    (right
	(inst  name="u_pads_in/u_btn_3_"	 place_status=placed offset = 190)
	(inst  name="u_pads_pwr/VSS3_13_"	 place_status=placed space = 70)
	(inst  name="u_pads_pwr/VSS3_12_"	 place_status=placed )
